...
describe('helpers:url', () => {
  describe('buildURL', () => {
    ...
    test('should support special array params', () => {
      expect(
        buildURL('/foo', {
          foo: ['bar', 'baz']
        })
  ...
  describe('isAbsoluteURL', () => {
    test('should return true if URL brgins with vaild scheme name', () => {
  ...
  describe('combineURL', () => {
    ...
    test('should not insert slash when relative url missing or empty', () => {
      expect(combineURL('https://api.github.com/users', '')).toBe('https://api.github.com/users')
    })
  ...
  describe('isURLSameOrigin', () => {
    ...
    test('should detect defferent origin', () => {
